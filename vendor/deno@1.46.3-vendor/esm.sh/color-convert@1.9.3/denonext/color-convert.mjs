/* esm.sh - color-convert@1.9.3 */
import * as __0$ from "../../../esm.sh/color-name@1.1.3/denonext/color-name.mjs";
var require = (n) => {
...
var R =
  ((r) =>
    typeof require < "u"
      ? require
      : typeof Proxy < "u"
      ? new Proxy(r, { get: (a, e) => (typeof require < "u" ? require : a)[e] })
      : r)(function (r) {
      if (typeof require < "u") {
...
var w = (r, a) => () => (a || r((a = { exports: {} }).exports, a), a.exports);
var U = (r, a, e, n) => {
  if (a && typeof a == "object" || typeof a == "function") {
    for (let t of K(a)) {
      !D.call(r, t) && t !== e &&
        d(r, t, {
          get: () => a[t],
          enumerable: !(n = I(a, t)) || n.enumerable,
        });
    }
  }
  return r;
...
var B = (
  ...
  U(
    a || !r || !r.__esModule
      ? d(e, "default", { value: r, enumerable: !0 })
      : e,
    r,
  ));
var y = w((Y, j) => {
  var b = R("color-name"), O = {};
  for (g in b) {
    b.hasOwnProperty(g) && (O[b[g]] = g);
  }
  var g,
    s = j.exports = {
  ...
  for (f in s) {
    if (s.hasOwnProperty(f)) {
      ...
      k = s[f].channels,
        ...
        delete s[f].channels,
        delete s[f].labels,
        Object.defineProperty(s[f], "channels", { value: k }),
        Object.defineProperty(s[f], "labels", { value: F });
    }
  }
  var k, F, f;
  ...
  s.rgb.cmyk = function (r) {
    var a = r[0] / 255, e = r[1] / 255, n = r[2] / 255, t, v, i, u;
    return u = Math.min(1 - a, 1 - e, 1 - n),
      t = (1 - a - u) / (1 - u) || 0,
      v = (1 - e - u) / (1 - u) || 0,
      i = (1 - n - u) / (1 - u) || 0,
      [t * 100, v * 100, i * 100, u * 100];
  };
  function G(r, a) {
  ...
  s.rgb.lab = function (r) {
    var a = s.rgb.xyz(r), e = a[0], n = a[1], t = a[2], v, i, u;
    return e /= 95.047,
      n /= 100,
      t /= 108.883,
  ...
  s.hsl.rgb = function (r) {
    var a = r[0] / 360, e = r[1] / 100, n = r[2] / 100, t, v, i, u, c;
    if (e === 0) {
      return c = n * 255, [c, c, c];
    }
  ...
  s.hsv.hsl = function (r) {
    var a = r[0], e = r[1] / 100, n = r[2] / 100, t = Math.max(n, .01), v, i, u;
    return u = (2 - e) * n,
      v = (2 - e) * t,
      i = e * t,
      i /= v <= 1 ? v : 2 - v,
  ...
  s.hwb.rgb = function (r) {
    var a = r[0] / 360, e = r[1] / 100, n = r[2] / 100, t = e + n, v, i, u, c;
    t > 1 && (e /= t, n /= t),
      v = Math.floor(6 * a),
      i = 1 - n,
      u = 6 * a - v,
  ...
  s.cmyk.rgb = function (r) {
    var a = r[0] / 100, e = r[1] / 100, n = r[2] / 100, t = r[3] / 100, v, i, u;
    return v = 1 - Math.min(1, a * (1 - t) + t),
      i = 1 - Math.min(1, e * (1 - t) + t),
      u = 1 - Math.min(1, n * (1 - t) + t),
      [v * 255, i * 255, u * 255];
  };
  s.xyz.rgb = function (r) {
    var a = r[0] / 100, e = r[1] / 100, n = r[2] / 100, t, v, i;
    return t = a * 3.2406 + e * -1.5372 + n * -.4986,
      v = a * -.9689 + e * 1.8758 + n * .0415,
      i = a * .0557 + e * -.204 + n * 1.057,
      t = t > .0031308 ? 1.055 * Math.pow(t, 1 / 2.4) - .055 : t * 12.92,
      v = v > .0031308 ? 1.055 * Math.pow(v, 1 / 2.4) - .055 : v * 12.92,
  ...
  s.lab.xyz = function (r) {
    ...
    var u = Math.pow(v, 3), c = Math.pow(t, 3), h = Math.pow(i, 3);
    return v = u > .008856 ? u : (v - 16 / 116) / 7.787,
      t = c > .008856 ? c : (t - 16 / 116) / 7.787,
      i = h > .008856 ? h : (i - 16 / 116) / 7.787,
      t *= 95.047,
      v *= 100,
      i *= 108.883,
      [t, v, i];
  ...
  s.rgb.ansi16 = function (r) {
    ...
    var v = 30 +
      (Math.round(n / 255) << 2 | Math.round(e / 255) << 1 |
        Math.round(a / 255));
    return t === 2 && (v += 60), v;
  };
  ...
  s.rgb.ansi256 = function (r) {
    ...
    var t = 16 + 36 * Math.round(a / 255 * 5) + 6 * Math.round(e / 255 * 5) +
      Math.round(n / 255 * 5);
    return t;
  };
  ...
  s.rgb.hex = function (r) {
    var a = ((Math.round(r[0]) & 255) << 16) + ((Math.round(r[1]) & 255) << 8) +
        (Math.round(r[2]) & 255),
  ...
  s.hex.rgb = function (r) {
    ...
    var n = parseInt(e, 16), t = n >> 16 & 255, v = n >> 8 & 255, i = n & 255;
    return [t, v, i];
  };
  ...
  s.hcg.rgb = function (r) {
    ...
    var t = [0, 0, 0], v = a % 1 * 6, i = v % 1, u = 1 - i, c = 0;
    switch (Math.floor(v)) {
      case 0:
        t[0] = 1, t[1] = i, t[2] = 0;
        break;
    ...
    return c = (1 - e) * n,
      [(e * t[0] + c) * 255, (e * t[1] + c) * 255, (e * t[2] + c) * 255];
  };
  ...
  s.hcg.hsl = function (r) {
    var a = r[1] / 100, e = r[2] / 100, n = e * (1 - a) + .5 * a, t = 0;
    return n > 0 && n < .5
      ? t = a / (2 * n)
      : n >= .5 && n < 1 && (t = a / (2 * (1 - n))),
      [r[0], t * 100, n * 100];
  ...
  s.hwb.hcg = function (r) {
    var a = r[1] / 100, e = r[2] / 100, n = 1 - e, t = n - a, v = 0;
...
var P = w((Z, z) => {
  var M = y();
  function H() {
    for (var r = {}, a = Object.keys(M), e = a.length, n = 0; n < e; n++) {
      r[a[n]] = { distance: -1, parent: null };
    }
    return r;
  }
  function J(r) {
    ...
    for (a[r].distance = 0; e.length;) {
      for (
        var n = e.pop(), t = Object.keys(M[n]), v = t.length, i = 0;
        i < v;
        i++
      ) {
        var u = t[i], c = a[u];
        c.distance === -1 &&
          (c.distance = a[n].distance + 1, c.parent = n, e.unshift(u));
      }
    }
    return a;
  }
  ...
  function N(r, a) {
    for (
      var e = [a[r].parent, r], n = M[a[r].parent][r], t = a[r].parent;
      a[t].parent;
    ) {
      e.unshift(a[t].parent), n = L(M[a[t].parent][t], n), t = a[t].parent;
    }
    return n.conversion = e, n;
  }
  z.exports = function (r) {
    for (
      var a = J(r), e = {}, n = Object.keys(a), t = n.length, v = 0;
      v < t;
      v++
    ) {
      var i = n[v], u = a[i];
...
var C = w((_, q) => {
  ...
  T.forEach(function (r) {
    p[r] = {},
      Object.defineProperty(p[r], "channels", { value: m[r].channels }),
      Object.defineProperty(p[r], "labels", { value: m[r].labels });
    var a = Q(r), e = Object.keys(a);
    e.forEach(function (n) {
      var t = a[n];
      p[r][n] = W(t), p[r][n].raw = V(t);
    });
  });
  q.exports = p;
});
var x = B(C()), $ = x.default ?? x;
export { $ as default };
//# sourceMappingURL=color-convert.mjs.map
