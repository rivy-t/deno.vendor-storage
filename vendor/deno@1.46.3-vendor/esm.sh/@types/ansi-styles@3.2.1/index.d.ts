...
import { EscapeCode } from "./escape-code.d.ts";
...
export const color: EscapeCode.Color & EscapeCode.ColorType & {
  close: string;
};
export const bgColor: EscapeCode.BackgroundColor & EscapeCode.ColorType & {
  close: string;
};
