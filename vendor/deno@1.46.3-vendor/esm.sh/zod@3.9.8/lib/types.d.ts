...
> {
  ...
  spa: (
    data: unknown,
    params?: Partial<ParseParamsNoData> | undefined,
  ) => Promise<
    {
      success: true;
      data: Output;
...
export declare const mergeObjects: <First extends AnyZodObject>(
  first: First,
  ...
  First["_unknownKeys"],
  First["_catchall"],
  objectOutputType<First["_shape"] & Second["_shape"], First["_catchall"]>,
  objectInputType<First["_shape"] & Second["_shape"], First["_catchall"]>
>;
...
> = ZodTypeAny extends Catchall ? baseObjectOutputType<Shape>
  : objectUtil.flatten<
...
export declare type objectInputType<
  Shape extends ZodRawShape,
  Catchall extends ZodTypeAny,
> = ZodTypeAny extends Catchall ? baseObjectInputType<Shape>
  : objectUtil.flatten<
    baseObjectInputType<Shape> & {
      [k: string]: Catchall["_input"];
    }
  >;
declare type deoptional<T extends ZodTypeAny> = T extends ZodOptional<infer U>
  ? deoptional<U>
  : T;
...
> extends ZodType<Output, ZodObjectDef<T, UnknownKeys, Catchall>, Input> {
  ...
  augment: <Augmentation extends ZodRawShape>(
    ...
    UnknownKeys,
    Catchall,
    objectOutputType<extendShape<T, Augmentation>, Catchall>,
    objectInputType<extendShape<T, Augmentation>, Catchall>
  >;
...
export declare class ZodLiteral<T extends any>
...
> extends ZodType<Output, ZodEffectsDef<T>, Input> {
  ...
  static create: <I extends ZodTypeAny>(
    ...
    params?: RawCreateParams,
  ) => ZodEffects<I, I["_output"], I["_input"]>;
...
export declare type ZodFirstPartySchemaTypes =
  ...
  | ZodDefault<any>
  | ZodPromise<any>;
declare const instanceOfType: <T extends new (...args: any[]) => any>(
  cls: T,
  params?: Parameters<ZodTypeAny["refine"]>[1],
