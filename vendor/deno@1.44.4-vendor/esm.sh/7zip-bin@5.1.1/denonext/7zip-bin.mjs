...
var d =
  ((r) =>
    typeof require < "u"
      ? require
      : typeof Proxy < "u"
      ? new Proxy(r, { get: (e, a) => (typeof require < "u" ? require : e)[a] })
      : r)(function (r) {
      if (typeof require < "u") {
...
var j = (
  ...
  x(
    e || !r || !r.__esModule
      ? c(a, "default", { value: r, enumerable: !0 })
      : a,
    r,
  ));
var p = l((i) => {
  ...
  var s = d("node:path");
  function z() {
    return __Process$.env.USE_SYSTEM_7ZA === "true"
      ? "7za"
      : __Process$.platform === "darwin"
      ? s.join("/7zip-bin@5.1.1/denonext", "mac", __Process$.arch, "7za")
      : __Process$.platform === "win32"
      ? s.join("/7zip-bin@5.1.1/denonext", "win", __Process$.arch, "7za.exe")
      : s.join("/7zip-bin@5.1.1/denonext", "linux", __Process$.arch, "7za");
  }
  i.path7za = z();
  i.path7x = s.join("/7zip-bin@5.1.1/denonext", "7x.sh");
});
var n = j(p()), { path7za: E, path7x: g } = n, q = n.default ?? n;
export { E as path7za, g as path7x, q as default };
